        ...
        projects: [
            {
                ...
                text:
                    'Figma sketch of Contactless Ticketing prototype for Temi robot.',
            },
            {
            ...
            },
            {
                ...
                src: barnesWWW,
                text:
                    "Searching for paintings by Henri Rousseau using the updated search feature on the Barnes' flagship site.",
                isVideo: true,
            },
            {
...
export const TEST = PORTFOLIO_ASSETS.work.projects.filter(
    (project) => project.src
);
